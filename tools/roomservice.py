...
custom_local_manifest = ".repo/local_manifests/aosp_manifest.xml"
custom_default_revision = "nougat"
custom_dependencies = "aosp.dependencies"
org_manifest = "AospExtended"  # leave empty if org is provided in manifest
org_display = "AospExtended"  # needed for displaying
